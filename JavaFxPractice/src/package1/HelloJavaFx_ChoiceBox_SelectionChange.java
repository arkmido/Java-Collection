...
/**
 *
 * Listening for ChoiceBox selection change event
 */
...
public class HelloJavaFx_ChoiceBox_SelectionChange extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        // get the user selected item by using the 
        // choicebox selection model and add a listener to it
